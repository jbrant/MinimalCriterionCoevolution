...
namespace MCC_Domains.MazeNavigation.MCNSExperiment
{
    public class SteadyStateMazeNavigationMCNSExperiment : BaseMazeNavigationExperiment
    {
            ...
            List<NeatGenome> genomeList, ulong startingEvaluations)
        {
            ...
            var mazeNavigationEvaluator = new MazeNavigationMCNSEvaluator(MaxDistanceToTarget, MazeVariant,
