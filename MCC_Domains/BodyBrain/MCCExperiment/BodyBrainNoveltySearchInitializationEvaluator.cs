...
namespace MCC_Domains.BodyBrain.MCCExperiment
{
    ...
    public class BodyBrainNoveltySearchInitializationEvaluator : IPhenomeEvaluator<VoxelBrain, BehaviorInfo>
    {
        ...
        public BehaviorInfo Evaluate(VoxelBrain brain, uint currentGeneration)
        {
            ...
            var simConfigFilePath = BodyBrainExperimentUtils.ConstructVoxelyzeFilePath("config_init",
                _simulationProperties.SimConfigOutputDirectory, _experimentName, _run, _voxelBody.GenomeId,
                brain.GenomeId);

            // Construct output file path
            var simResultFilePath = BodyBrainExperimentUtils.ConstructVoxelyzeFilePath("result_init",
