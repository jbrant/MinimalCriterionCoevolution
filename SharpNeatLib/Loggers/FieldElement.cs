namespace SharpNeat.Loggers
{
    public class EvolutionFieldElements
    {
        ...
        public static readonly FieldElement MinimalCriteriaPointX = new FieldElement(9, "Minimal Criteria MazeStructurePoint X");
        public static readonly FieldElement MinimalCriteriaPointY = new FieldElement(10, "Minimal Criteria MazeStructurePoint Y");
