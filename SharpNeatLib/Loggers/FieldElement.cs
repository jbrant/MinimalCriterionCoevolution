namespace SharpNeat.Loggers
{
    public class EvolutionFieldElements
    {
        ...
        public static readonly FieldElement ChampGenomeDistanceToTarget = new FieldElement(22,
            "Champ Genome Distance to Target");

        public static readonly FieldElement ChampGenomeBehaviorX = new FieldElement(23, "Champ Genome Behavior X");
        public static readonly FieldElement ChampGenomeBehaviorY = new FieldElement(24, "Champ Genome Behavior Y");
    }
    ...
    public class McsEvaluationFieldElements
    {
        public static readonly FieldElement Generation = new FieldElement(0, "Generation");
        public static readonly FieldElement EvaluationCount = new FieldElement(1, "Evaluation Count");
